import{S as ge,i as _e,s as pe,e as m,t as u,k,c as b,a as g,h as v,d as c,m as I,b as w,g as E,J as i,E as C,F as nn,G as sn,H as rn,I as ln,q as T,o as D,Z as on,v as Jt,u as an,D as cn,j as Ve,_ as dn,M as Lt,w as M,x as j,y as A,B as P,n as Kt,p as Qt,P as hn,K as fn,Q as un,$ as Rt}from"../../chunks/index-1895426b.js";import"../../chunks/codeblocks-d759b035.js";import{s as vn,a as mn,b as bn,S as Zt,N as Xt,P as Yt,e as gn,M as _n}from"../../chunks/appendSelect-74b5d6d1.js";import{d as pn,c as wn}from"../../chunks/index-573acb59.js";import{w as yn}from"../../chunks/index-e5f949a9.js";import{o as En}from"../../chunks/noun-presentation-1320578-0041c878.js";import"../../chunks/paths-396f020f.js";function kn(l){let e,n,t,s,r,h,d,a,o,f,_,y,p,L,x,F,O,G,q,re,H,ce,de,he,Q,Me,it=0+"",je,U,fe,Z,Ae,st=!0+"",we,Pe,Be,ye,He,Ee,Ue,ke,Re,le,V,X,We,qe,oe,z,rt=.7+"",Ie,Fe,Ge,Oe,Je,Le,$e,Ke,Qe,Ze,Se,Te,Xe,Ye,Y,ue,et,De,J,ae,ze,ee,tt,$,R,ie,lt,W,se,ot,xe,at,nt,ct,ve,te,Ne,dt,ht,ft,me,ut,N,be,vt;return{c(){e=m("p"),n=u(`Using IntersectionObserver via the 
	...
	via a Svelte store.`),o=k(),f=m("h3"),_=u("Main points"),y=k(),p=m("ul"),L=m("li"),x=m("span"),F=u("Use two separate intersection observers"),O=k(),G=m("li"),q=u(`We need two intersection observers if we want to do lazy loading and change 
		...
		we load the element. This happens only once (`),Z=m("code"),Ae=u('once="'),we=u(st),Pe=u('"'),Be=u(`), 
		...
		rather than trying to load all of them at once on page load/component mount.`),le=k(),V=m("li"),X=m("span"),We=u(`The second (inner) intersection observer is there to affect a change 
		...
		has to be visible in the viewport to trigger the intersecting prop to become true.`),Ye=k(),Y=m("li"),ue=m("span"),et=u("To update the content of the sticky element:"),De=k(),J=m("ul"),ae=m("li"),ze=u("- Initialise a "),ee=m("code"),tt=u("currentElNum"),$=u(" variable as a svelte store."),R=k(),ie=m("li"),lt=u("- Set the value of "),W=m("code"),se=u("currentElNum"),ot=u(` to the id corresponding 
	...
	via a Svelte store.`),B.forEach(c),o=I(S),f=b(S,"H3",{class:!0});var pt=g(f);_=v(pt,"Main points"),pt.forEach(c),y=I(S),p=b(S,"UL",{class:!0});var K=g(p);L=b(K,"LI",{});var $t=g(L);x=b($t,"SPAN",{class:!0});var St=g(x);F=v(St,"Use two separate intersection observers"),St.forEach(c),$t.forEach(c),O=I(K),G=b(K,"LI",{});var Tt=g(G);q=v(Tt,`We need two intersection observers if we want to do lazy loading and change 
		...
		we load the element. This happens only once (`),Z=b(Ce,"CODE",{});var yt=g(Z);Ae=v(yt,'once="'),we=v(yt,st),Pe=v(yt,'"'),yt.forEach(c),Be=v(Ce,`), 
		which makes sense because we don't need to lazy-load more than once. 
		...
		loading really heavy chunks of content, e.g. HTML5 canvas elements with thousands of 
		shapes drawn in each of them, it would help performance to lazy-load each canvas as it comes into view,
		rather than trying to load all of them at once on page load/component mount.`),zt.forEach(c),le=I(K),V=b(K,"LI",{});var ne=g(V);X=b(ne,"SPAN",{class:!0});var xt=g(X);We=v(xt,`The second (inner) intersection observer is there to affect a change 
...
`;function Un(l){let e;return{c(){e=m("div")},l(n){e=b(n,"DIV",{}),g(e).forEach(c)},m(n,t){E(n,e,t)},p:C,i:C,o:C,d(n){n&&c(e)}}}function Rn(l){let e,n;return e=new Yt({props:{language:"javascript",source:Hn,showCopyButton:!0}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p:C,i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){D(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function Wn(l){let e,n,t,s,r,h;e=new In({});const d=[Rn,Un],a=[];function o(f,_){return 0}return s=o(),r=a[s]=d[s](l),{c(){M(e.$$.fragment),n=k(),t=m("div"),r.c(),this.h()},l(f){j(e.$$.fragment,f),n=I(f),t=b(f,"DIV",{class:!0});var _=g(t);r.l(_),_.forEach(c),this.h()},h(){w(t,"class","codeblock svelte-knnyit")},m(f,_){A(e,f,_),E(f,n,_),E(f,t,_),a[s].m(t,null),h=!0},p(f,_){r.p(f,_)},i(f){h||(T(e.$$.fragment,f),T(r),h=!0)},o(f){D(e.$$.fragment,f),D(r),h=!1},d(f){P(e,f),f&&c(n),f&&c(t),a[s].d()}}}function qn(l){let e,n;return{c(){e=m("h2"),n=u(l[1]),this.h()},l(t){e=b(t,"H2",{slot:!0,class:!0});var s=g(e);n=v(s,l[1]),s.forEach(c),this.h()},h(){w(e,"slot","title"),w(e,"class","svelte-knnyit")},m(t,s){E(t,e,s),i(e,n)},p(t,s){s&2&&Ve(n,t[1])},d(t){t&&c(e)}}}function Fn(l){let e,n,t;return{c(){e=m("div"),n=m("a"),t=u(l[4]),this.h()},l(s){e=b(s,"DIV",{slot:!0,class:!0});var r=g(e);n=b(r,"A",{href:!0});var h=g(n);t=v(h,l[4]),h.forEach(c),r.forEach(c),this.h()},h(){w(n,"href",l[3]),w(e,"slot","external-link"),w(e,"class","external-link")},m(s,r){E(s,e,r),i(e,n),i(n,t)},p(s,r){r&16&&Ve(t,s[4]),r&8&&w(n,"href",s[3])},d(s){s&&c(e)}}}function Gn(l){let e,n,t,s,r,h;return e=new Xt({props:{internalLink:l[2],date:l[5],$$slots:{"external-link":[Fn],title:[qn],default:[Wn]},$$scope:{ctx:l}}}),r=new Bn({}),{c(){M(e.$$.fragment),n=k(),t=m("br"),s=k(),M(r.$$.fragment)},l(d){j(e.$$.fragment,d),n=I(d),t=b(d,"BR",{}),s=I(d),j(r.$$.fragment,d)},m(d,a){A(e,d,a),E(d,n,a),E(d,t,a),E(d,s,a),A(r,d,a),h=!0},p(d,a){const o={};a&4&&(o.internalLink=d[2]),a&32&&(o.date=d[5]),a&90&&(o.$$scope={dirty:a,ctx:d}),e.$set(o)},i(d){h||(T(e.$$.fragment,d),T(r.$$.fragment,d),h=!0)},o(d){D(e.$$.fragment,d),D(r.$$.fragment,d),h=!1},d(d){P(e,d),d&&c(n),d&&c(t),d&&c(s),P(r,d)}}}function Jn(l){let e,n;return e=new Zt({props:{id:l[0],$$slots:{default:[Gn]},$$scope:{ctx:l}}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p(t,[s]){const r={};s&1&&(r.id=t[0]),s&126&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){D(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function Kn(l,e,n){let{id:t}=e,{sectionTitle:s}=e,{internalLink:r}=e,{externalLink:h}=e,{externalLinkTitle:d}=e,{date:a}=e;return l.$$set=o=>{"id"in o&&n(0,t=o.id),"sectionTitle"in o&&n(1,s=o.sectionTitle),"internalLink"in o&&n(2,r=o.internalLink),"externalLink"in o&&n(3,h=o.externalLink),"externalLinkTitle"in o&&n(4,d=o.externalLinkTitle),"date"in o&&n(5,a=o.date)},[t,s,r,h,d,a]}class Qn extends ge{constructor(e){super(),_e(this,e,Kn,Jn,pe,{id:0,sectionTitle:1,internalLink:2,externalLink:3,externalLinkTitle:4,date:5})}}function Zn(l){let e,n,t,s,r,h,d,a,o,f,_,y,p,L,x,F,O,G,q,re,H,ce,de,he,Q,Me,it,je,U,fe,Z,Ae,st,we,Pe,Be,ye,He,Ee,Ue,ke,Re,le,V,X,We,qe,oe,z,rt,Ie,Fe,Ge,Oe,Je,Le,$e,Ke,Qe,Ze,Se,Te,Xe,Ye,Y,ue,et,De,J,ae,ze,ee,tt;return{c(){e=m("p"),n=u(`Using just the built-in 
	...
	affecting a change in the DOM when an element intersects the viewport.`),h=k(),d=m("h3"),a=u("Main points"),o=k(),f=m("ul"),_=m("li"),y=u("The built-in "),p=m("code"),L=u("IntersectionObserver"),x=u(` class takes in two 
		...
		These are static properties.`),je=k(),U=m("li"),fe=m("span"),Z=m("code"),Ae=u("observerCallback"),st=u(`
		...
		*Note that if we then wanted to run any logic that depends on `),Ee=m("code"),Ue=u("inView"),ke=u(`, it would need to 
		...
		make the cade reactive, just like in other examples here.`),Re=k(),le=m("li"),V=u("Then we "),X=m("span"),We=u("instantiate the IntersectionObserver and start observing the desired element from onMount"),qe=u(`. 
		...
		*Note that the note above about `),Te=m("code"),Xe=u("inView"),Ye=u(` only being able to affect a change if it is 
		...
		(e.g. DOM-events from Svelte like `),Y=m("code"),ue=u("on:click"),et=u(" or class conditions like "),De=m("code"),J=u("class:active"),ae=u(` etc.) 
	...
	affecting a change in the DOM when an element intersects the viewport.`),R.forEach(c),h=I($),d=b($,"H3",{class:!0});var lt=g(d);a=v(lt,"Main points"),lt.forEach(c),o=I($),f=b($,"UL",{class:!0});var W=g(f);_=b(W,"LI",{});var se=g(_);y=v(se,"The built-in "),p=b(se,"CODE",{});var ot=g(p);L=v(ot,"IntersectionObserver"),ot.forEach(c),x=v(se,` class takes in two 
		...
		are things like the threshold at which an element is 
		considered intersecting (as a proportion of the total height of the element). 
		These are static properties.`),nt.forEach(c),je=I(W),U=b(W,"LI",{});var te=g(U);fe=b(te,"SPAN",{class:!0});var Ne=g(fe);Z=b(Ne,"CODE",{});var dt=g(Z);Ae=v(dt,"observerCallback"),dt.forEach(c),Ne.forEach(c),st=v(te,`
		 determines what happens when the intersection event occurs. 
		...
		*Note that if we then wanted to run any logic that depends on `),Ee=b(te,"CODE",{});var ft=g(Ee);Ue=v(ft,"inView"),ft.forEach(c),ke=v(te,`, it would need to 
		be wrapped in a reactive declaration. For example, if we then wanted to draw a D3 graph, we'd need to 
		make the cade reactive, just like in other examples here.`),te.forEach(c),Re=I(W),le=b(W,"LI",{});var me=g(le);V=v(me,"Then we "),X=b(me,"SPAN",{class:!0});var ut=g(X);We=v(ut,"instantiate the IntersectionObserver and start observing the desired element from onMount"),ut.forEach(c),qe=v(me,`. 
		...
		`),Ze=b(N,"BR",{}),Se=v(N,`
		*Note that the note above about `),Te=b(N,"CODE",{});var B=g(Te);Xe=v(B,"inView"),B.forEach(c),Ye=v(N,` only being able to affect a change if it is 
		wrapped in a reactive statement doesn't apply in this case. This is because Svlete-native DOM changes 
		(e.g. DOM-events from Svelte like `),Y=b(N,"CODE",{});var gt=g(Y);ue=v(gt,"on:click"),gt.forEach(c),et=v(N," or class conditions like "),De=b(N,"CODE",{});var _t=g(De);J=v(_t,"class:active"),_t.forEach(c),ae=v(N,` etc.) 
		are reactive by design.`),N.forEach(c),W.forEach(c),ze=I($),ee=b($,"H3",{class:!0});var pt=g(ee);tt=v(pt,"Code highlights"),pt.forEach(c),this.h()},h(){w(t,"href","https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API"),w(t,"target","_blank"),w(t,"class","svelte-19j31zf"),w(e,"class","summary svelte-19j31zf"),w(d,"class","svelte-19j31zf"),w(he,"class","accent"),w(fe,"class","accent"),w(X,"class","accent"),w(f,"class","svelte-19j31zf"),w(ee,"class","svelte-19j31zf")},m($,R){E($,e,R),i(e,n),i(e,t),i(t,s),i(e,r),E($,h,R),E($,d,R),i(d,a),E($,o,R),E($,f,R),i(f,_),i(_,y),i(_,p),i(p,L),i(_,x),i(_,F),i(F,O),i(_,G),i(_,q),i(q,re),i(_,H),i(f,ce),i(f,de),i(de,he),i(he,Q),i(Q,Me),i(de,it),i(f,je),i(f,U),i(U,fe),i(fe,Z),i(Z,Ae),i(U,st),i(U,we),i(we,Pe),i(U,Be),i(U,ye),i(U,He),i(U,Ee),i(Ee,Ue),i(U,ke),i(f,Re),i(f,le),i(le,V),i(le,X),i(X,We),i(le,qe),i(f,oe),i(f,z),i(z,rt),i(z,Ie),i(Ie,Fe),i(z,Ge),i(z,Oe),i(Oe,Je),i(z,Le),i(z,$e),i($e,Ke),i(z,Qe),i(z,Ze),i(z,Se),i(z,Te),i(Te,Xe),i(z,Ye),i(z,Y),i(Y,ue),i(z,et),i(z,De),i(De,J),i(z,ae),E($,ze,R),E($,ee,R),i(ee,tt)},p:C,i:C,o:C,d($){$&&c(e),$&&c(h),$&&c(d),$&&c(o),$&&c(f),$&&c(ze),$&&c(ee)}}}class Xn extends ge{constructor(e){super(),_e(this,e,null,Zn,pe,{})}}function Yn(l){let e,n,t,s,r;return{c(){e=m("section"),n=m("h3"),t=u(`When 50% of the element below are into the viewport, it will change colour.
