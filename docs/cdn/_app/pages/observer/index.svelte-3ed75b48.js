import{S as ge,i as _e,s as pe,e as m,t as u,k,c as b,a as g,h as v,d as c,m as I,b as w,g as E,J as i,E as D,R as nn,F as sn,G as rn,H as ln,I as on,q as T,o as C,T as an,v as Jt,u as cn,D as dn,j as Ve,U as hn,M as Lt,w as M,x as j,y as A,B as P,n as Kt,p as Qt,P as fn,K as un,V as vn,W as Rt}from"../../chunks/index-3b89fb51.js";import"../../chunks/codeblocks-00307bc8.js";import{s as mn,a as bn,b as gn,S as Xt,N as Yt,P as Zt,e as _n,M as pn}from"../../chunks/appendSelect-1aa13c28.js";import{w as wn}from"../../chunks/index-26d188c2.js";import{d as yn}from"../../chunks/index-e312e58d.js";import{o as En}from"../../chunks/noun-presentation-1320578-0041c878.js";import"../../chunks/paths-396f020f.js";function kn(l){let e,n,t,s,r,h,d,a,o,f,_,y,p,L,x,F,O,G,q,re,H,ce,de,he,Q,Me,it=0+"",je,U,fe,X,Ae,st=!0+"",we,Pe,Be,ye,He,Ee,Ue,ke,Re,le,V,Y,We,qe,oe,z,rt=.7+"",Ie,Fe,Ge,Oe,Je,Le,$e,Ke,Qe,Xe,Se,Te,Ye,Ze,Z,ue,et,Ce,J,ae,ze,ee,tt,$,R,ie,lt,W,se,ot,xe,at,nt,ct,ve,te,Ne,dt,ht,ft,me,ut,N,be,vt;return{c(){e=m("p"),n=u(`Using IntersectionObserver via the 
	...
	via a Svelte store.`),o=k(),f=m("h3"),_=u("Main points"),y=k(),p=m("ul"),L=m("li"),x=m("span"),F=u("Use two separate intersection observers"),O=k(),G=m("li"),q=u(`We need two intersection observers if we want to do lazy loading and change 
		...
		has to be visible in the viewport to trigger the intersecting prop to become true.`),Ze=k(),Z=m("li"),ue=m("span"),et=u("To update the content of the sticky element:"),Ce=k(),J=m("ul"),ae=m("li"),ze=u("- Initialise a "),ee=m("code"),tt=u("currentElNum"),$=u(" variable as a svelte store."),R=k(),ie=m("li"),lt=u("- Set the value of "),W=m("code"),se=u("currentElNum"),ot=u(` to the id corresponding 
	...
	via a Svelte store.`),B.forEach(c),o=I(S),f=b(S,"H3",{class:!0});var pt=g(f);_=v(pt,"Main points"),pt.forEach(c),y=I(S),p=b(S,"UL",{class:!0});var K=g(p);L=b(K,"LI",{});var $t=g(L);x=b($t,"SPAN",{class:!0});var St=g(x);F=v(St,"Use two separate intersection observers"),St.forEach(c),$t.forEach(c),O=I(K),G=b(K,"LI",{});var Tt=g(G);q=v(Tt,`We need two intersection observers if we want to do lazy loading and change 
		...
		If the elements don't need to lazy-load or if they don't need to 
		change in any way after they have first loaded, then we only need one 
		IntersectionObserver.`),Tt.forEach(c),re=I(K),H=b(K,"LI",{});var De=g(H);ce=b(De,"SPAN",{class:!0});var Ct=g(ce);de=v(Ct,"The first (outer) intersection observer is for lazy loading."),Ct.forEach(c),he=v(De,`
		It observers each element and if the element enters the viewport (`),Q=b(De,"CODE",{});var wt=g(Q);Me=v(wt,'threshold="'),je=v(wt,it),U=v(wt,'"'),wt.forEach(c),fe=v(De,`), 
		we load the element. This happens only once (`),X=b(De,"CODE",{});var yt=g(X);Ae=v(yt,'once="'),we=v(yt,st),Pe=v(yt,'"'),yt.forEach(c),Be=v(De,`), 
		which makes sense because we don't need to lazy-load more than once. 
		The lazy loading bit is achieved by adding the condition `),ye=b(De,"CODE",{});var Dt=g(ye);He=v(Dt,"if intersecting"),Dt.forEach(c),Ee=v(De,`  
		as then we will only display the DOM element if it intersects the viewport.`),De.forEach(c),Ue=I(K),ke=b(K,"LI",{});var zt=g(ke);Re=v(zt,`In this particular example there is no need to use lazy loading actually, but if we were 
		loading really heavy chunks of content, e.g. HTML5 canvas elements with thousands of 
		shapes drawn in each of them, it would help performance to lazy-load each canvas as it comes into view,
	...
	`),t=b(h,"H3",{class:!0});var d=g(t);s=v(d,l[0]),d.forEach(c),h.forEach(c),this.h()},h(){w(t,"class","svelte-1t17e91"),w(e,"id","sticky-element"),w(e,"class","svelte-1t17e91")},m(r,h){E(r,e,h),i(e,n),i(e,t),i(t,s)},p(r,[h]){h&1&&Ve(s,r[0])},i:D,o:D,d(r){r&&c(e)}}}function Cn(l,e,n){let t;return hn(l,tn,s=>n(0,t=s)),[t]}class Dn extends ge{constructor(e){super(),_e(this,e,Cn,Tn,pe,{})}}function zn(l){let e,n,t,s,r,h,d,a,o,f,_;return{c(){e=m("div"),n=m("h1"),t=u("I am block #"),s=u(l[0]),r=u(" and my intersection status is: "),h=u(l[1]),d=k(),a=m("p"),o=u(l[2]),f=k(),_=m("div"),this.h()},l(y){e=b(y,"DIV",{class:!0});var p=g(e);n=b(p,"H1",{class:!0});var L=g(n);t=v(L,"I am block #"),s=v(L,l[0]),r=v(L," and my intersection status is: "),h=v(L,l[1]),L.forEach(c),d=I(p),a=b(p,"P",{class:!0});var x=g(a);o=v(x,l[2]),x.forEach(c),f=I(p),_=b(p,"DIV",{class:!0}),g(_).forEach(c),p.forEach(c),this.h()},h(){w(n,"class","svelte-16oryz2"),w(a,"class","svelte-16oryz2"),w(_,"class","container"),w(e,"class","content svelte-16oryz2")},m(y,p){E(y,e,p),i(e,n),i(n,t),i(n,s),i(n,r),i(n,h),i(e,d),i(e,a),i(a,o),i(e,f),i(e,_),l[5](_)},p(y,[p]){p&1&&Ve(s,y[0]),p&2&&Ve(h,y[1]),p&4&&Ve(o,y[2])},i:D,o:D,d(y){y&&c(e),l[5](null)}}}function xn(l,e,n){mn.prototype.appendSelect=bn;let{id:t}=e,{intersecting:s}=e,{text:r}=e,h;function d(a){Lt[a?"unshift":"push"](()=>{h=a,n(3,h)})}return l.$$set=a=>{"id"in a&&n(0,t=a.id),"intersecting"in a&&n(1,s=a.intersecting),"text"in a&&n(2,r=a.text)},l.$$.update=()=>{l.$$.dirty&27&&h&&(gn(h).appendSelect("svg").attr("width","100%").attr("height","600px").transition().duration(500).style("background",o=>s?"#ee3e3e":"#6b6065"),s&&tn.set(t))},[t,s,r,h,yn,d]}class Nn extends ge{constructor(e){super(),_e(this,e,xn,zn,pe,{id:0,intersecting:1,text:2})}}const qt=[{id:0,text:"some content text"},{id:1,text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{id:2,text:"Ut enim ad minim veniam, uis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."},{id:3,text:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."},{id:4,text:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}];function Ft(l,e,n){const t=l.slice();return t[16]=e[n],t[17]=e,t[18]=n,t}function Vn(l){let e,n;return{c(){e=m("div"),n=u("loading..."),this.h()},l(t){e=b(t,"DIV",{class:!0});var s=g(e);n=v(s,"loading..."),s.forEach(c),this.h()},h(){w(e,"class","placeholder svelte-1wdlev2")},m(t,s){E(t,e,s),i(e,n)},p:D,i:D,o:D,d(t){t&&c(e)}}}function Mn(l){let e,n;return e=new en({props:{element:l[1][l[18]],threshold:.7,once:!1,$$slots:{default:[jn,({intersecting:t})=>({3:t}),({intersecting:t})=>t?8:0]},$$scope:{ctx:l}}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p(t,s){const r={};s&2&&(r.element=t[1][t[18]]),s&524298&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){C(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function jn(l){let e,n,t=l[18],s,r;n=new Nn({props:{id:l[16].id,intersecting:l[3],text:l[16].text}});const h=()=>l[4](e,t),d=()=>l[4](null,t);return{c(){e=m("div"),M(n.$$.fragment)},l(a){e=b(a,"DIV",{});var o=g(e);j(n.$$.fragment,o),o.forEach(c)},m(a,o){E(a,e,o),A(n,e,null),h(),r=!0},p(a,o){l=a;const f={};o&8&&(f.intersecting=l[3]),n.$set(f),t!==l[18]&&(d(),t=l[18],h())},i(a){r||(T(n.$$.fragment,a),s||un(()=>{s=vn(e,On,{duration:800}),s.start()}),r=!0)},o(a){C(n.$$.fragment,a),r=!1},d(a){a&&c(e),P(n),d()}}}function An(l){let e,n,t,s=l[18],r,h;const d=[Mn,Vn],a=[];function o(y,p){return y[2]?0:1}n=o(l),t=a[n]=d[n](l);const f=()=>l[5](e,s),_=()=>l[5](null,s);return{c(){e=m("div"),t.c(),r=k()},l(y){e=b(y,"DIV",{});var p=g(e);t.l(p),p.forEach(c),r=I(y)},m(y,p){E(y,e,p),a[n].m(e,null),f(),E(y,r,p),h=!0},p(y,p){l=y;let L=n;n=o(l),n===L?a[n].p(l,p):(Kt(),C(a[L],1,1,()=>{a[L]=null}),Qt(),t=a[n],t?t.p(l,p):(t=a[n]=d[n](l),t.c()),T(t,1),t.m(e,null)),s!==l[18]&&(_(),s=l[18],f())},i(y){h||(T(t),h=!0)},o(y){C(t),h=!1},d(y){y&&c(e),a[n].d(),_(),y&&c(r)}}}function Gt(l){let e,n;return e=new en({props:{element:l[0][l[18]],threshold:0,once:!0,$$slots:{default:[An,({intersecting:t})=>({2:t}),({intersecting:t})=>t?4:0]},$$scope:{ctx:l}}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p(t,s){const r={};s&1&&(r.element=t[0][t[18]]),s&524295&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){C(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function Pn(l){let e,n,t,s;n=new Dn({});let r=qt,h=[];for(let a=0;a<r.length;a+=1)h[a]=Gt(Ft(l,r,a));const d=a=>C(h[a],1,1,()=>{h[a]=null});return{c(){e=m("section"),M(n.$$.fragment),t=k();for(let a=0;a<h.length;a+=1)h[a].c()},l(a){e=b(a,"SECTION",{});var o=g(e);j(n.$$.fragment,o),t=I(o);for(let f=0;f<h.length;f+=1)h[f].l(o);o.forEach(c)},m(a,o){E(a,e,o),A(n,e,null),i(e,t);for(let f=0;f<h.length;f+=1)h[f].m(e,null);s=!0},p(a,[o]){if(o&15){r=qt;let f;for(f=0;f<r.length;f+=1){const _=Ft(a,r,f);h[f]?(h[f].p(_,o),T(h[f],1)):(h[f]=Gt(_),h[f].c(),T(h[f],1),h[f].m(e,null))}for(Kt(),f=r.length;f<h.length;f+=1)d(f);Qt()}},i(a){if(!s){T(n.$$.fragment,a);for(let o=0;o<r.length;o+=1)T(h[o]);s=!0}},o(a){C(n.$$.fragment,a),h=h.filter(Boolean);for(let o=0;o<h.length;o+=1)C(h[o]);s=!1},d(a){a&&c(e),P(n),fn(h,a)}}}function Bn(l,e,n){let t,s,r,h,d;const a=[t,s,r,h,d];let o,f,_,y,p;const L=[o,f,_,y,p];let x,F;function O(q,re){Lt[q?"unshift":"push"](()=>{L[re]=q,n(1,L)})}function G(q,re){Lt[q?"unshift":"push"](()=>{a[re]=q,n(0,a)})}return[a,L,x,F,O,G]}class Hn extends ge{constructor(e){super(),_e(this,e,Bn,Pn,pe,{})}}const Un=`
	///////////////////////////////////////////////////////////////
...
`;function Rn(l){let e;return{c(){e=m("div")},l(n){e=b(n,"DIV",{}),g(e).forEach(c)},m(n,t){E(n,e,t)},p:D,i:D,o:D,d(n){n&&c(e)}}}function Wn(l){let e,n;return e=new Zt({props:{language:"javascript",source:Un,showCopyButton:!0}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p:D,i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){C(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function qn(l){let e,n,t,s,r,h;e=new In({});const d=[Wn,Rn],a=[];function o(f,_){return 0}return s=o(),r=a[s]=d[s](l),{c(){M(e.$$.fragment),n=k(),t=m("div"),r.c(),this.h()},l(f){j(e.$$.fragment,f),n=I(f),t=b(f,"DIV",{class:!0});var _=g(t);r.l(_),_.forEach(c),this.h()},h(){w(t,"class","codeblock svelte-knnyit")},m(f,_){A(e,f,_),E(f,n,_),E(f,t,_),a[s].m(t,null),h=!0},p(f,_){r.p(f,_)},i(f){h||(T(e.$$.fragment,f),T(r),h=!0)},o(f){C(e.$$.fragment,f),C(r),h=!1},d(f){P(e,f),f&&c(n),f&&c(t),a[s].d()}}}function Fn(l){let e,n;return{c(){e=m("h2"),n=u(l[1]),this.h()},l(t){e=b(t,"H2",{slot:!0,class:!0});var s=g(e);n=v(s,l[1]),s.forEach(c),this.h()},h(){w(e,"slot","title"),w(e,"class","svelte-knnyit")},m(t,s){E(t,e,s),i(e,n)},p(t,s){s&2&&Ve(n,t[1])},d(t){t&&c(e)}}}function Gn(l){let e,n,t;return{c(){e=m("div"),n=m("a"),t=u(l[4]),this.h()},l(s){e=b(s,"DIV",{slot:!0,class:!0});var r=g(e);n=b(r,"A",{href:!0});var h=g(n);t=v(h,l[4]),h.forEach(c),r.forEach(c),this.h()},h(){w(n,"href",l[3]),w(e,"slot","external-link"),w(e,"class","external-link")},m(s,r){E(s,e,r),i(e,n),i(n,t)},p(s,r){r&16&&Ve(t,s[4]),r&8&&w(n,"href",s[3])},d(s){s&&c(e)}}}function Jn(l){let e,n,t,s,r,h;return e=new Yt({props:{internalLink:l[2],date:l[5],$$slots:{"external-link":[Gn],title:[Fn],default:[qn]},$$scope:{ctx:l}}}),r=new Hn({}),{c(){M(e.$$.fragment),n=k(),t=m("br"),s=k(),M(r.$$.fragment)},l(d){j(e.$$.fragment,d),n=I(d),t=b(d,"BR",{}),s=I(d),j(r.$$.fragment,d)},m(d,a){A(e,d,a),E(d,n,a),E(d,t,a),E(d,s,a),A(r,d,a),h=!0},p(d,a){const o={};a&4&&(o.internalLink=d[2]),a&32&&(o.date=d[5]),a&90&&(o.$$scope={dirty:a,ctx:d}),e.$set(o)},i(d){h||(T(e.$$.fragment,d),T(r.$$.fragment,d),h=!0)},o(d){C(e.$$.fragment,d),C(r.$$.fragment,d),h=!1},d(d){P(e,d),d&&c(n),d&&c(t),d&&c(s),P(r,d)}}}function Kn(l){let e,n;return e=new Xt({props:{id:l[0],$$slots:{default:[Jn]},$$scope:{ctx:l}}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p(t,[s]){const r={};s&1&&(r.id=t[0]),s&126&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){C(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function Qn(l,e,n){let{id:t}=e,{sectionTitle:s}=e,{internalLink:r}=e,{externalLink:h}=e,{externalLinkTitle:d}=e,{date:a}=e;return l.$$set=o=>{"id"in o&&n(0,t=o.id),"sectionTitle"in o&&n(1,s=o.sectionTitle),"internalLink"in o&&n(2,r=o.internalLink),"externalLink"in o&&n(3,h=o.externalLink),"externalLinkTitle"in o&&n(4,d=o.externalLinkTitle),"date"in o&&n(5,a=o.date)},[t,s,r,h,d,a]}class Xn extends ge{constructor(e){super(),_e(this,e,Qn,Kn,pe,{id:0,sectionTitle:1,internalLink:2,externalLink:3,externalLinkTitle:4,date:5})}}function Yn(l){let e,n,t,s,r,h,d,a,o,f,_,y,p,L,x,F,O,G,q,re,H,ce,de,he,Q,Me,it,je,U,fe,X,Ae,st,we,Pe,Be,ye,He,Ee,Ue,ke,Re,le,V,Y,We,qe,oe,z,rt,Ie,Fe,Ge,Oe,Je,Le,$e,Ke,Qe,Xe,Se,Te,Ye,Ze,Z,ue,et,Ce,J,ae,ze,ee,tt;return{c(){e=m("p"),n=u(`Using just the built-in 
	...
	affecting a change in the DOM when an element intersects the viewport.`),h=k(),d=m("h3"),a=u("Main points"),o=k(),f=m("ul"),_=m("li"),y=u("The built-in "),p=m("code"),L=u("IntersectionObserver"),x=u(` class takes in two 
		...
		*Note that if we then wanted to run any logic that depends on `),Ee=m("code"),Ue=u("inView"),ke=u(`, it would need to 
		...
		make the cade reactive, just like in other examples here.`),Re=k(),le=m("li"),V=u("Then we "),Y=m("span"),We=u("instantiate the IntersectionObserver and start observing the desired element from onMount"),qe=u(`. 
		...
		*Note that the note above about `),Te=m("code"),Ye=u("inView"),Ze=u(` only being able to affect a change if it is 
		...
		(e.g. DOM-events from Svelte like `),Z=m("code"),ue=u("on:click"),et=u(" or class conditions like "),Ce=m("code"),J=u("class:active"),ae=u(` etc.) 
	...
	affecting a change in the DOM when an element intersects the viewport.`),R.forEach(c),h=I($),d=b($,"H3",{class:!0});var lt=g(d);a=v(lt,"Main points"),lt.forEach(c),o=I($),f=b($,"UL",{class:!0});var W=g(f);_=b(W,"LI",{});var se=g(_);y=v(se,"The built-in "),p=b(se,"CODE",{});var ot=g(p);L=v(ot,"IntersectionObserver"),ot.forEach(c),x=v(se,` class takes in two 
		...
		*Note that if we then wanted to run any logic that depends on `),Ee=b(te,"CODE",{});var ft=g(Ee);Ue=v(ft,"inView"),ft.forEach(c),ke=v(te,`, it would need to 
		be wrapped in a reactive declaration. For example, if we then wanted to draw a D3 graph, we'd need to 
		make the cade reactive, just like in other examples here.`),te.forEach(c),Re=I(W),le=b(W,"LI",{});var me=g(le);V=v(me,"Then we "),Y=b(me,"SPAN",{class:!0});var ut=g(Y);We=v(ut,"instantiate the IntersectionObserver and start observing the desired element from onMount"),ut.forEach(c),qe=v(me,`. 
		...
		*Note that the note above about `),Te=b(N,"CODE",{});var B=g(Te);Ye=v(B,"inView"),B.forEach(c),Ze=v(N,` only being able to affect a change if it is 
		wrapped in a reactive statement doesn't apply in this case. This is because Svlete-native DOM changes 
		(e.g. DOM-events from Svelte like `),Z=b(N,"CODE",{});var gt=g(Z);ue=v(gt,"on:click"),gt.forEach(c),et=v(N," or class conditions like "),Ce=b(N,"CODE",{});var _t=g(Ce);J=v(_t,"class:active"),_t.forEach(c),ae=v(N,` etc.) 
		are reactive by design.`),N.forEach(c),W.forEach(c),ze=I($),ee=b($,"H3",{class:!0});var pt=g(ee);tt=v(pt,"Code highlights"),pt.forEach(c),this.h()},h(){w(t,"href","https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API"),w(t,"target","_blank"),w(t,"class","svelte-19j31zf"),w(e,"class","summary svelte-19j31zf"),w(d,"class","svelte-19j31zf"),w(he,"class","accent"),w(fe,"class","accent"),w(Y,"class","accent"),w(f,"class","svelte-19j31zf"),w(ee,"class","svelte-19j31zf")},m($,R){E($,e,R),i(e,n),i(e,t),i(t,s),i(e,r),E($,h,R),E($,d,R),i(d,a),E($,o,R),E($,f,R),i(f,_),i(_,y),i(_,p),i(p,L),i(_,x),i(_,F),i(F,O),i(_,G),i(_,q),i(q,re),i(_,H),i(f,ce),i(f,de),i(de,he),i(he,Q),i(Q,Me),i(de,it),i(f,je),i(f,U),i(U,fe),i(fe,X),i(X,Ae),i(U,st),i(U,we),i(we,Pe),i(U,Be),i(U,ye),i(U,He),i(U,Ee),i(Ee,Ue),i(U,ke),i(f,Re),i(f,le),i(le,V),i(le,Y),i(Y,We),i(le,qe),i(f,oe),i(f,z),i(z,rt),i(z,Ie),i(Ie,Fe),i(z,Ge),i(z,Oe),i(Oe,Je),i(z,Le),i(z,$e),i($e,Ke),i(z,Qe),i(z,Xe),i(z,Se),i(z,Te),i(Te,Ye),i(z,Ze),i(z,Z),i(Z,ue),i(z,et),i(z,Ce),i(Ce,J),i(z,ae),E($,ze,R),E($,ee,R),i(ee,tt)},p:D,i:D,o:D,d($){$&&c(e),$&&c(h),$&&c(d),$&&c(o),$&&c(f),$&&c(ze),$&&c(ee)}}}class Zn extends ge{constructor(e){super(),_e(this,e,null,Yn,pe,{})}}function ei(l){let e,n,t,s,r;return{c(){e=m("section"),n=m("h3"),t=u(`When 50% of the element below are into the viewport, it will change colour.
    Scroll up and down the page to see.`),s=k(),r=m("div"),this.h()},l(h){e=b(h,"SECTION",{class:!0});var d=g(e);n=b(d,"H3",{class:!0});var a=g(n);t=v(a,`When 50% of the element below are into the viewport, it will change colour.
    Scroll up and down the page to see.`),a.forEach(c),s=I(d),r=b(d,"DIV",{id:!0,class:!0}),g(r).forEach(c),d.forEach(c),this.h()},h(){w(n,"class","svelte-1ous08w"),w(r,"id","observed-element"),w(r,"class","content-to-scroll-over svelte-1ous08w"),Rt(r,"active",l[0]),w(e,"class","svelte-1ous08w")},m(h,d){E(h,e,d),i(e,n),i(n,t),i(e,s),i(e,r)},p(h,[d]){d&1&&Rt(r,"active",h[0])},i:D,o:D,d(h){h&&c(e)}}}function ti(l,e,n){const t={threshold:.5};let s=!1;const r=h=>{for(const d of h)d.isIntersecting&&!s?n(0,s=!0):!d.isIntersecting&&s&&n(0,s=!1)};return Jt(()=>{const h=document.getElementById("observed-element");new IntersectionObserver(r,t).observe(h)}),l.$$.update=()=>{l.$$.dirty&1&&console.log(s)},[s]}class ni extends ge{constructor(e){super(),_e(this,e,ti,ei,pe,{})}}const ii=`
<script>
...
`;function si(l){let e;return{c(){e=m("div")},l(n){e=b(n,"DIV",{}),g(e).forEach(c)},m(n,t){E(n,e,t)},p:D,i:D,o:D,d(n){n&&c(e)}}}function ri(l){let e,n;return e=new Zt({props:{language:"javascript",source:ii,showCopyButton:!0}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p:D,i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){C(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function li(l){let e,n,t,s,r,h;e=new Zn({});const d=[ri,si],a=[];function o(f,_){return 0}return s=o(),r=a[s]=d[s](l),{c(){M(e.$$.fragment),n=k(),t=m("div"),r.c(),this.h()},l(f){j(e.$$.fragment,f),n=I(f),t=b(f,"DIV",{class:!0});var _=g(t);r.l(_),_.forEach(c),this.h()},h(){w(t,"class","codeblock svelte-knnyit")},m(f,_){A(e,f,_),E(f,n,_),E(f,t,_),a[s].m(t,null),h=!0},p(f,_){r.p(f,_)},i(f){h||(T(e.$$.fragment,f),T(r),h=!0)},o(f){C(e.$$.fragment,f),C(r),h=!1},d(f){P(e,f),f&&c(n),f&&c(t),a[s].d()}}}function oi(l){let e,n;return{c(){e=m("h2"),n=u(l[1]),this.h()},l(t){e=b(t,"H2",{slot:!0,class:!0});var s=g(e);n=v(s,l[1]),s.forEach(c),this.h()},h(){w(e,"slot","title"),w(e,"class","svelte-knnyit")},m(t,s){E(t,e,s),i(e,n)},p(t,s){s&2&&Ve(n,t[1])},d(t){t&&c(e)}}}function ai(l){let e,n,t;return{c(){e=m("div"),n=m("a"),t=u(l[4]),this.h()},l(s){e=b(s,"DIV",{slot:!0,class:!0});var r=g(e);n=b(r,"A",{href:!0});var h=g(n);t=v(h,l[4]),h.forEach(c),r.forEach(c),this.h()},h(){w(n,"href",l[3]),w(e,"slot","external-link"),w(e,"class","external-link")},m(s,r){E(s,e,r),i(e,n),i(n,t)},p(s,r){r&16&&Ve(t,s[4]),r&8&&w(n,"href",s[3])},d(s){s&&c(e)}}}function ci(l){let e,n,t,s,r,h;return e=new Yt({props:{internalLink:l[2],date:l[5],$$slots:{"external-link":[ai],title:[oi],default:[li]},$$scope:{ctx:l}}}),r=new ni({}),{c(){M(e.$$.fragment),n=k(),t=m("br"),s=k(),M(r.$$.fragment)},l(d){j(e.$$.fragment,d),n=I(d),t=b(d,"BR",{}),s=I(d),j(r.$$.fragment,d)},m(d,a){A(e,d,a),E(d,n,a),E(d,t,a),E(d,s,a),A(r,d,a),h=!0},p(d,a){const o={};a&4&&(o.internalLink=d[2]),a&32&&(o.date=d[5]),a&90&&(o.$$scope={dirty:a,ctx:d}),e.$set(o)},i(d){h||(T(e.$$.fragment,d),T(r.$$.fragment,d),h=!0)},o(d){C(e.$$.fragment,d),C(r.$$.fragment,d),h=!1},d(d){P(e,d),d&&c(n),d&&c(t),d&&c(s),P(r,d)}}}function di(l){let e,n;return e=new Xt({props:{id:l[0],$$slots:{default:[ci]},$$scope:{ctx:l}}}),{c(){M(e.$$.fragment)},l(t){j(e.$$.fragment,t)},m(t,s){A(e,t,s),n=!0},p(t,[s]){const r={};s&1&&(r.id=t[0]),s&126&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){n||(T(e.$$.fragment,t),n=!0)},o(t){C(e.$$.fragment,t),n=!1},d(t){P(e,t)}}}function hi(l,e,n){let{id:t}=e,{sectionTitle:s}=e,{internalLink:r}=e,{externalLink:h}=e,{externalLinkTitle:d}=e,{date:a}=e;return l.$$set=o=>{"id"in o&&n(0,t=o.id),"sectionTitle"in o&&n(1,s=o.sectionTitle),"internalLink"in o&&n(2,r=o.internalLink),"externalLink"in o&&n(3,h=o.externalLink),"externalLinkTitle"in o&&n(4,d=o.externalLinkTitle),"date"in o&&n(5,a=o.date)},[t,s,r,h,d,a]}class fi extends ge{constructor(e){super(),_e(this,e,hi,di,pe,{id:0,sectionTitle:1,internalLink:2,externalLink:3,externalLinkTitle:4,date:5})}}const ui=[{anchor:"#svelte-intersection-observer-lazy-loading",title:"Svelte Intersection Observer + lazy loading"},{anchor:"#vanilla-intersection-observer",title:"Vanilla Intersection Observer"}];function vi(l){let e,n;return{c(){e=m("h1"),n=u("Intersection Observer"),this.h()},l(t){e=b(t,"H1",{slot:!0});var s=g(e);n=v(s,"Intersection Observer"),s.forEach(c),this.h()},h(){w(e,"slot","title")},m(t,s){E(t,e,s),i(e,n)},p:D,d(t){t&&c(e)}}}function mi(l){let e,n,t,s,r,h,d,a;return e=new _n({props:{icon:En,$$slots:{title:[vi]},$$scope:{ctx:l}}}),t=new pn({props:{menuItems:ui}}),r=new Xn({props:{id:"svelte-intersection-observer-lazy-loading",sectionTitle:"Svelte Intersection Observer lazy loading",externalLink:"https://svelte.dev/repl/310510e6e6c3464f9518c55b6ad50f25?version=3.48.0",externalLinkTitle:"Svelte repl",internalLink:"https://github.com/reuters-graphics/example_svelte-graph-patterns/tree/main/src/lib/components/observer/SvelteIntersectionObserverLazyLoading",date:"April 2022"}}),d=new fi({props:{id:"vanilla-intersection-observer",sectionTitle:"Vanilla Intersection Observer",externalLink:"https://svelte.dev/repl/d9bc0f84d467495991518091456fa01f?version=3.48.0",externalLinkTitle:"Svelte repl",internalLink:"https://github.com/reuters-graphics/example_svelte-graph-patterns/tree/main/src/lib/components/observer/VanillaIntersectionObserver",date:"April 2022"}}),{c(){M(e.$$.fragment),n=k(),M(t.$$.fragment),s=k(),M(r.$$.fragment),h=k(),M(d.$$.fragment)},l(o){j(e.$$.fragment,o),n=I(o),j(t.$$.fragment,o),s=I(o),j(r.$$.fragment,o),h=I(o),j(d.$$.fragment,o)},m(o,f){A(e,o,f),E(o,n,f),A(t,o,f),E(o,s,f),A(r,o,f),E(o,h,f),A(d,o,f),a=!0},p(o,[f]){const _={};f&1&&(_.$$scope={dirty:f,ctx:o}),e.$set(_)},i(o){a||(T(e.$$.fragment,o),T(t.$$.fragment,o),T(r.$$.fragment,o),T(d.$$.fragment,o),a=!0)},o(o){C(e.$$.fragment,o),C(t.$$.fragment,o),C(r.$$.fragment,o),C(d.$$.fragment,o),a=!1},d(o){P(e,o),o&&c(n),P(t,o),o&&c(s),P(r,o),o&&c(h),P(d,o)}}}class ki extends ge{constructor(e){super(),_e(this,e,null,mi,pe,{})}}export{ki as default};
