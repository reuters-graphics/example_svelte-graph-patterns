<script>
  ...
  import SvelteGraphWithTransitions from '$lib/components/graphs/SvelteGraphWithTransitions/index.svelte';
...
<SvelteFirstGraphPattern1 
  ...
  date='April 2022'
/>
<SvelteGraphWithTransitions 
  id='svelte-graph-with-transitions' 
